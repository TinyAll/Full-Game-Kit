...
public static class MissionManager
{
	...
	public static void SetupUnits(int aMission)
	{
		...
		GameObject units = missionHolder.transform.FindChild(name).gameObject;
	...
	public static void SetupDestructibles(int aMission)
	{
		...
		GameObject miscs = missionHolder.transform.FindChild(name).gameObject; //  No good since it errors when there is none. Should not be done differently.
