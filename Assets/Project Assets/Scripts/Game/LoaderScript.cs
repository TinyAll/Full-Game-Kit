...
{	
	...
	void Awake()
	{
		...
		loadingBarFillTransform = preloaderPanel.transform.FindChild("LoadingBar/Fill");
		loadingBarText = preloaderPanel.transform.FindChild("LoadingBar/Text").GetComponent<Text>();
