...
public class Tank : Vehicle {
	...
	public override void InitializeSpecific()
	{
		...
		tankData.turret = transform.FindChild ("Tank/TankTurret").gameObject;
		tankData.barrel = transform.FindChild ("Tank/TankTurret/TankTurretBarrel").gameObject;
		GameObject tMuzzleFlashDummy = transform.FindChild ("Tank/TankTurret/TankTurretBarrel/TankMuzzleFlash").gameObject;
