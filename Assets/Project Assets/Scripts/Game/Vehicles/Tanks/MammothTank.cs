...
public class MammothTank : Vehicle {
	...
	public override void InitializeSpecific()
	{
		...
		mammothTankData.turret = transform.FindChild("MammothTank/MammothTankTurret").gameObject;
		mammothTankData.barrel = transform.FindChild("MammothTank/MammothTankTurret/MammothTankBarrels").gameObject;
		mammothTankData.launcher = transform.FindChild("MammothTank/MammothTankTurret/MammothTankLaunchers").gameObject;
		GameObject muzzleFlash1Dummy = transform.FindChild("MammothTank/MammothTankTurret/MammothTankBarrels/MammothTankMuzzleFlash1").gameObject;
		GameObject muzzleFlash2Dummy = transform.FindChild("MammothTank/MammothTankTurret/MammothTankBarrels/MammothTankMuzzleFlash2").gameObject;
		GameObject muzzleFlash3Dummy = transform.FindChild("MammothTank/MammothTankTurret/MammothTankLaunchers/MammothTankMuzzleFlash3").gameObject;
		GameObject muzzleFlash4Dummy = transform.FindChild("MammothTank/MammothTankTurret/MammothTankLaunchers/MammothTankMuzzleFlash4").gameObject;
