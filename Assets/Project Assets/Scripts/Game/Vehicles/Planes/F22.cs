...
public class F22 : Vehicle {
	...
	public override void InitializeSpecific()
	{
		...
		f22Data.turret = transform.FindChild("F22").gameObject;
		f22Data.barrel = transform.FindChild("F22/F22Missiles").gameObject;
		GameObject muzzleFlashDummy1 = transform.FindChild("F22/F22Missiles/F22MuzzleFlash1").gameObject;
		GameObject muzzleFlashDummy2 = transform.FindChild("F22/F22Missiles/F22MuzzleFlash2").gameObject;
		GameObject muzzleFlashDummy3 = transform.FindChild("F22/F22Missiles/F22MuzzleFlash3").gameObject;
		GameObject muzzleFlashDummy4 = transform.FindChild("F22/F22Missiles/F22MuzzleFlash4").gameObject;
	...
	{
		f22Data.F22Trail1.transform.FindChild("MuzzleFlashRear").GetComponent<ParticleSystem>().enableEmission = true;
		f22Data.F22Trail1.transform.FindChild("Trail").GetComponent<ParticleSystem>().enableEmission = true;
		f22Data.F22Trail2.transform.FindChild("MuzzleFlashRear").GetComponent<ParticleSystem>().enableEmission = true;
		f22Data.F22Trail2.transform.FindChild("Trail").GetComponent<ParticleSystem>().enableEmission = true;
	}
	
	// Deactivate the Thrust particle effects
	public void DeactivateRearThrust()
	{
		f22Data.F22Trail1.transform.FindChild("MuzzleFlashRear").GetComponent<ParticleSystem>().enableEmission = false;
		f22Data.F22Trail1.transform.FindChild("Trail").GetComponent<ParticleSystem>().enableEmission = false;
		f22Data.F22Trail2.transform.FindChild("MuzzleFlashRear").GetComponent<ParticleSystem>().enableEmission = false;
		f22Data.F22Trail2.transform.FindChild("Trail").GetComponent<ParticleSystem>().enableEmission = false;
	}
}