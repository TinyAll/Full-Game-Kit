...
public class MissileTurret : Vehicle {
	...
	public override void InitializeSpecific()
	{
		...
		missileTurretData.turret = transform.FindChild("MissileTurret/MissileTurretTurret").gameObject;
		missileTurretData.barrel = transform.FindChild("MissileTurret/MissileTurretTurret/MissileTurretPods").gameObject;
		GameObject muzzleFlash1Dummy = transform.FindChild("MissileTurret/MissileTurretTurret/MissileTurretPods/MissileTurretMuzzleFlash1").gameObject;
		GameObject muzzleFlash2Dummy = transform.FindChild("MissileTurret/MissileTurretTurret/MissileTurretPods/MissileTurretMuzzleFlash2").gameObject;
