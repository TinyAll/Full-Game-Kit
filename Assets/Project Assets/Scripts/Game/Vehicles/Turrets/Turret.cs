...
public class Turret : Vehicle {
	...
	public override void InitializeSpecific()
	{
		...
		turretData.turret = transform.FindChild("Turret/TurretTurret").gameObject;
		turretData.barrel = transform.FindChild("Turret/TurretTurret/TurretGuns").gameObject;
		GameObject muzzleFlash1Dummy = transform.FindChild("Turret/TurretTurret/TurretGuns/TurretMuzzleFlash1").gameObject;
		GameObject muzzleFlash2Dummy = transform.FindChild("Turret/TurretTurret/TurretGuns/TurretMuzzleFlash2").gameObject;
