...
public class Helicopter : Vehicle {
	...
	public override void InitializeSpecific()
	{
		...
		helicopterData.body = transform.FindChild("Helicopter").gameObject;
		helicopterData.barrel = transform.FindChild("Helicopter/HelicopterGuns").gameObject;
		helicopterData.mainRotor = transform.FindChild("Helicopter/HelicopterMainRotor").gameObject;
		helicopterData.tailRotor = transform.FindChild("Helicopter/HelicopterTailRotor").gameObject;

		// Add the muzzleflashs to the gameObject
		GameObject muzzleFlashDummy1 = transform.FindChild("Helicopter/HelicopterGuns/HelicopterMuzzleFlash1").gameObject;
		GameObject muzzleFlashDummy2 = transform.FindChild("Helicopter/HelicopterGuns/HelicopterMuzzleFlash2").gameObject;
