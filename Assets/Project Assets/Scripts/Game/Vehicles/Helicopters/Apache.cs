...
public class Apache : Vehicle {
	...
	public override void InitializeSpecific()
	{
		...
		apacheData.body = transform.FindChild("Apache").gameObject;
		apacheData.gun = transform.FindChild("Apache/ApacheGun").gameObject;
		apacheData.rocketLauncher = transform.FindChild("Apache/ApacheMissilePods").gameObject;
		apacheData.mainRotor = transform.FindChild("Apache/ApacheMainRotor").gameObject;
		apacheData.tailRotor = transform.FindChild("Apache/ApacheTailRotor").gameObject;
		GameObject muzzleFlashDummy = transform.FindChild("Apache/ApacheGun/ApacheMuzzleFlash5").gameObject;
		GameObject muzzleFlashDummy1 = transform.FindChild("Apache/ApacheMissilePods/ApacheMuzzleFlash1").gameObject;
		GameObject muzzleFlashDummy2 = transform.FindChild("Apache/ApacheMissilePods/ApacheMuzzleFlash2").gameObject;
		GameObject muzzleFlashDummy3 = transform.FindChild("Apache/ApacheMissilePods/ApacheMuzzleFlash3").gameObject;
		GameObject muzzleFlashDummy4 = transform.FindChild("Apache/ApacheMissilePods/ApacheMuzzleFlash4").gameObject;
